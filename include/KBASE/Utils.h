...
/* 将DomainLevel和ulGroupID组装成新的groupid*/
AFX_EXT_CLASS void AssemblyGroupID(const std::string& strDomain,unsigned long ulGroupID,unsigned long& ulNewGroupID);

/* 将ulNewGroupID拆分成nLevel和ulGroupID*/
AFX_EXT_CLASS void UnAssemblyGroupID(unsigned long ulNewGroupID,unsigned int& nLevel,unsigned long& ulGroupID);

/* 将ulNewGroupID拆分出ulGroupID*/
AFX_EXT_CLASS unsigned long UnAssemblyGroupID2UL(unsigned long ulNewGroupID);

/* 将strNewGroupID拆分出strGroupID*/
AFX_EXT_CLASS std::string UnAssemblyGroupID2STR(const std::string& strNewGroupID);
